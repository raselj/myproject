...
<div class="content-wrapper" style="min-height: 1302.4px;">
    ...
    <div class="modal fade" id="modal-insert">
      <form action="{{route('childcategory.store')}}" method="post" autofocus autocomplete="on">
        @csrf
         <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">Add New Child Category</h4>
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value class="form-control @error('childcategory_name') is-invalid @enderror" id="childcategory_name" name="childcategory_name"  required autocomplete="childcategory_name" placeholder="Child Category Name">
                  </div>
    ...
    <div class="modal fade" id="child-edit">
       ...
       <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">Update Child Category</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
...
<script>
  ...
  $(document).ready(function() {
    $('body').on('click', '.edit', function() {
        ...
        $.get("/childcategory/edit/"+childid,function(data){
